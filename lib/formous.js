    ...
    return function (_Component) {
      ...
      _createClass(_class2, [{
        ...
        value: function componentWillMount() {
          ...
          var updatedFields = (0, _immutable.Map)();
          ...
          for (var fieldName in options.fields) {
            ...
            updatedFields = updatedFields.set(fieldName, (0, _immutable.Map)({
              events: events,
        ...
        value: function isFormValid(fields, options) {
          ...
          var fieldSeq = fields.keySeq();
          var examineFields = fieldSeq.filter(function (fieldName) {
            return fieldName !== excludeField;
          });

          if (examineFields.count() === 0) return true;

          var formValid = fieldSeq.filter(function (fieldName) {
            return fieldName !== excludeField;
          }).map(function (fieldName) {
            return fields.get(fieldName, {});
          }).reduce(function (a, b) {
            return ((typeof a === 'undefined' ? 'undefined' : _typeof(a)) === 'object' ? a.get('valid') : a) && b.get('valid');
          }, true);
        ...
        value: function markFieldAsValid(fieldName, valid, options) {
          var fields = this.state.fields.mergeDeep((0, _immutable.Map)(_defineProperty({}, fieldName, {
        ...
        value: function setDefaultValues(defaultData) {
          if (!this.defaultsSet) {
            ...
            var fallbackValue = (0, _immutable.Map)();
            ...
            for (var fieldName in defaultData) {
              ...
              defaults = defaults.set(fieldName, this.state.fields.get(fieldName, fallbackValue).merge((0, _immutable.Map)({
                valid: (0, _helpers.allTestsPassed)(testResults),
                value: defaultData[fieldName]
              })));
            }

            var fields = this.state.fields.merge(defaults);
